...
if ($district_weather_id <= 0) {
    $district_weather_id = 184745; 
}

$city_weather_id = strval($district_weather_id);

date_default_timezone_set("Africa/Nairobi");
$apiKey = "20d4ceba23a69e40d1d4706c25abb2d3"; 
                            ...
                            <div class="card text-white bg-gradient-secondary mb-3">
                                ...
                                <script>
                                    ...
                                    window.myWidgetParam.push({
                                        ...
                                        appid: '870887df4d2b01335921fe396c69a360',
                                        units: 'metric',
                                ...
                                <div class="card-body text-dark">
                                    <table
                                        class="table table-striped table-hover table- table-bordered bg-gradient-white text-center display"
                                        id="myTable">
                                        ...
                                        <tbody>
                                            ...
                                            <?php $loop = 0; foreach ($forecast as $f) {
                                                $loop++;
                                            ...
                                            ?>
                                                <tr class="text-center">
                                                    <td> <?php echo $date ?> </td>
                                                    <td> <?php echo $time ?> </td>
                                                    <td> <img src="http://openweathermap.org/img/w/<?php echo $f->weather[0]->icon; ?>.png"
                                                            class="weather-icon" />
                                                        <?php echo $f->main->temp_max; ?> &#8451; &nbsp; <span
                                                            class="min-temperature"><?php echo $f->main->temp_min; ?> &#8451; </span>
                                                    </td>
                                                    <td> <?php echo $f->weather[0]->main . ',' . $f->weather[0]->description; ?>
                                                    </td>
